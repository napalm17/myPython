...
class Main:
    ...
    def drawWidgets(self):
        ...
        self.slider.grid(row=0,ipadx=150)
        self.controls.pack(side=BOTTOM)
        self.c = Canvas(self.master, width = 500, height=500, bg=self.color_bg)
        self.c.pack(fill=BOTH, expand=True)
        self.but = Button(self.controls, text="Guess Digit", command=lambda: self.get_ss(self.c), padx=200, pady=10, bg='#e74c3c')
        self.but['font'] = myfont
        self.but.grid(row=1)
...
general_font = ('Times New Roman', 11)
root.option_add("*Font", general_font)
myfont = font.Font(size="15",family= "Cambria")
Main(root)
root.mainloop()